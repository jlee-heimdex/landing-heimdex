...
export default async function HomePage({ params }: HomePageProps) {
  ...
  const t = {
    ...
    en: {
      heroHeadline1: 'Know your videos without watching',
      heroHeadlineBrand: 'Heimdex',
      heroDesc: 'No viewing. No uploading. Just search.\nFrom key moment extraction to short-form content and reports — all automated.',
      ctaPrimary: 'Try It Free',
      ctaSecondary: 'Get in Touch',
      trustedLabel: 'Trusted by',
      trustedHeadline1: 'Proven in the field — ',
      trustedHeadlineBrand: 'Heimdex',
      useCasesHeadline1: "Spend less time watching,",
      useCasesHeadline2: "more time",
      useCasesHeadline3: ' creating',
      case1Tag: 'Thousands of CCTV hours into courtroom evidence in seconds',
      case1Title: 'Legal & Investigations',
      case1Desc: 'Stop scrubbing through hours of footage.\nSearch by behavior and context to pinpoint critical evidence instantly.',
      case2Tag: 'Search terabytes of archives in seconds, produce shorts on the spot',
      case2Title: 'Content & Production',
      case2Desc: 'No more digging through scattered drives.\nOne search finds the scene — AI turns it into a short.',
      case3Tag: 'From edge case discovery to publishable analysis',
      case3Title: 'Data & Research',
      case3Desc: "Stop manually hunting for anomalies frame by frame.\nDescribe what you need, extract the scene, and auto-generate analysis reports.",
      techHeadline1: 'Zero upload wait.',
      techHeadline2: 'The technology behind instant video intelligence',
      tech1Title: 'No upload required',
      tech1Desc: 'Analyze even gigabyte-scale videos directly where they live — no cloud upload, no waiting.',
      tech2Title: 'Works with any setup',
      tech2Desc: 'On-prem servers, NAS, local drives — Heimdex plugs into your existing storage. No migration needed.',
      tech3Title: '90% faster workflows',
      tech3Desc: 'Search by text instead of watching. Find the exact segments you need and auto-generate clips and reports.',
      tech4Title: 'Zero data exposure',
      tech4Desc: 'Your videos never leave your environment. Fully air-gapped analysis with no external access.',
